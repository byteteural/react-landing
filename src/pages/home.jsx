      ...
      <div className="lg:w-1/2 w-full p-8 flex flex-col justify-between">
        ...
        <div className="text-center lg:text-left mt-8">
          <h1 className="font-bold font-sans">
            <span className="text-6xl md:text-8xl bg-gradient-to-b from-orange-500 via-orange-400 to-orange-300 bg-clip-text text-transparent leading-normal">NPV</span>
